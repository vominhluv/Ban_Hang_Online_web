<?php
session_start();
//if (empty($_SESSION['Position'])) {  // có session hãy tắt cmt
                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                    ...
                                    <tr>
                                        ...
                                        $getid=$_GET['edit'];
//                                        echo $getid;
                                        $sql="select * from tb_sp where sp_id = '$getid'";
                                        ...
                                        <th></th>
                                            ...
                                            <th><input type="text" name="type" value="$type" /></th>
                                            <th><input type="text" name="name" value="$name"/></th>
                                            <th><input type="text" name="prices" value="$prices"/></th>
